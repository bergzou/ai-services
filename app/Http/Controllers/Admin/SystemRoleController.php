...
use App\Services\Admin\SystemRoleService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class SystemRoleController extends BaseController implements ControllerInterface
{
    ...
    public function getList(Request $request): JsonResponse
    {
        ...
        $services = new SystemRoleService();
    ...
    public function add(Request $request): JsonResponse
    {
        ...
        $services = AopProxy::make(SystemRoleService::class);
