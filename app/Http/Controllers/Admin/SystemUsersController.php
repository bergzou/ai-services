...
use App\Services\Admin\SystemUsersService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class SystemUsersController extends BaseController implements ControllerInterface
{
    ...
    public function getList(Request $request): JsonResponse
    {
        ...
        $services = new SystemUsersService();
    ...
    public function add(Request $request): JsonResponse
    {
        ...
        $services = AopProxy::make(SystemUsersService::class);
