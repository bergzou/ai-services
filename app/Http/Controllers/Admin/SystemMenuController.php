...
use App\Services\Admin\SystemMenuService;
use Illuminate\Http\JsonResponse;
use Illuminate\Http\Request;

class SystemMenuController extends BaseController implements ControllerInterface
{
    ...
    public function getList(Request $request): JsonResponse
    {
        ...
        $services = new SystemMenuService();
    ...
    public function add(Request $request): JsonResponse
    {
        ...
        $services = AopProxy::make(SystemMenuService::class);
