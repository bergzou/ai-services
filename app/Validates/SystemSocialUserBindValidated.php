...
class SystemSocialUserBindValidated extends BaseValidated implements ValidatesInterface
{
    /**
     * 定义验证规则数组
    ...
    public function rules(): array
    {
        return [
            ...
            'social_type' => 'required|integer', # 社交平台的类型
            'social_user_id' => 'required|integer', # 社交用户的编号
    ...
    public function customAttributes(): array
    {
        return [
            ...
            'social_user_id' => __('validated.300240'), # 社交用户的编号
