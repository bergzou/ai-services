...
class SystemTenantPackageValidated extends BaseValidated implements ValidatesInterface
{
    /**
     * 定义验证规则数组
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => 'required', # 套餐名
            'status' => 'required', # 套餐状态：1=正常， 2=停用
            'remark' => 'nullable', # 备注
            'menu_ids' => 'required', # 关联的菜单编号
    ...
    {
        return [
            'id' => __('validated.300293'), # 套餐编号
            'snowflake_id' => __('validated.300277'), # 雪花Id
            'name' => __('validated.300250'), # 套餐名
            'status' => __('validated.300251'), # 套餐状态
            'remark' => __('validated.300054'), # 备注
            'menu_ids' => __('validated.300252'), # 关联的菜单编号
