...
class SystemOauth2CodeValidated extends BaseValidated implements ValidatesInterface
{
    /**
     * 定义验证规则数组
    ...
    public function rules(): array
    {
        return [
            ...
            'code' => 'required|string|max:32', # 授权码
            ...
            'redirect_uri' => 'nullable|string|max:255', # 可重定向的 URI 地址
            'state' => 'required|string|max:255', # 状态
