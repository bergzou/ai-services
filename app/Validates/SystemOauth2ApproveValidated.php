...
class SystemOauth2ApproveValidated extends BaseValidated implements ValidatesInterface
{
    /**
     * 定义验证规则数组
    ...
    public function customAttributes(): array
    {
        return [
            ...
            'scope' => __('validated.300170'), # 授权范围
            'approved' => __('validated.300172'), # 是否接受
