...
class YudaoDemo03StudentValidated extends BaseValidated implements ValidatesInterface
{
    /**
     * 定义验证规则数组
    ...
    public function rules(): array
    {
        return [
            ...
            'birthday' => 'required|date_format:Y-m-d H:i:s', # 出生日期
    ...
    public function customAttributes(): array
    {
        return [
            ...
            'birthday' => __('validated.300276'), # 出生日期
