...
class SystemOauth2RefreshTokenModel extends BaseModel
{
    ...
    public $fillable = ['user_id','refresh_token','user_type','client_id','scopes','expires_time','created_at','created_by','updated_at','updated_by','is_deleted','deleted_at','deleted_by','tenant_id'];
